...
const PRODUCTS = [
  ...
  {id:'motsc_40mg', cat:'metabolico', tag:'Mitocondrial', nombre:'MOTS-C', presentacion:'40 mg / vial', precio:1180000, img:'img/motsc-40mg.webp', desc:'Presentación de alta concentración (40 mg) del péptido mitocondrial: energía celular, sensibilidad a la insulina y rendimiento metabólico. Ideal para protocolos extendidos.'},
  {id:'motsc_box', cat:'metabolico', tag:'Caja Premium', nombre:'MOTS-C PrimeHack', presentacion:'Caja · 10 mg / vial', precio:400000, img:'img/motsc-10mg-primehack.webp', desc:'Péptido mitocondrial en caja premium PrimeHack. Relacionado con energía celular, sensibilidad a la insulina y rendimiento metabólico.'},
  ...
  {id:'combo_perdida_reparadora', cat:'metabolico', tag:'Combo', nombre:'Combo Pérdida Reparadora', presentacion:'Retatrutide 10mg PrimeHack + BPC-157 o TB-500 5mg', precio:785000, img:'img/combo-perdida-reparadora-v2.webp', desc:'Por la compra de un Retatrutide 10mg PrimeHack llevas una unidad de BPC-157 o TB-500 5mg (FastMuscle, a elección). Une pérdida de peso metabólica con recuperación y reparación tisular en un solo protocolo.', destacado:true},
  {id:'combo_lean_recomp', cat:'metabolico', tag:'Combo', nombre:'Combo Lean Recomposition', presentacion:'Tesamorelina 10 mg + Ipamorelina 5 mg', precio:705000, img:'img/combo-lean-recomp.webp', desc:'Recomposición corporal, definición y recuperación. Diseñado para reducir la grasa abdominal, conservar masa muscular y mejorar la recuperación mediante una estimulación más completa de la producción natural de hormona de crecimiento.', destacado:true},
  {id:'combo_shape_glow', cat:'metabolico', tag:'Combo', nombre:'Combo Shape & Glow', presentacion:'Retatrutide 10 mg + GHK-Cu 50 mg', precio:990000, img:'img/combo-shape-glow.webp', desc:'Transforma tu cuerpo sin descuidar tu piel. Retatrutide trabaja sobre el control del apetito y la reducción de peso, mientras GHK-Cu apoya la producción de colágeno, la renovación del tejido y el cuidado general de la piel.', destacado:true},
  {id:'ghkcu', cat:'regen', tag:'Estética', nombre:'GHK-CU', presentacion:'100 mg / vial', precio:480000, img:'img/ghkcu-100mg.webp', desc:'Péptido regenerativo con cobre asociado a producción de colágeno, reparación tisular y salud de piel y cabello.', destacado:true},
  ...
  {id:'glutation_600mg', cat:'longevidad', tag:'Antioxidante', nombre:'Glutatión', presentacion:'600 mg / vial', precio:450000, img:'img/glutation-600mg.webp', desc:'Tripéptido antioxidante de alta pureza (≥99%). Referente en la neutralización de radicales libres y el soporte celular frente al estrés oxidativo.'},
  ...
  {id:'klow_box', cat:'regen', tag:'Caja Premium', nombre:'Klow PrimeHack', presentacion:'Caja · 80 mg / vial', precio:1200000, img:'img/klow-80mg-primehack.webp', desc:'Formulación de cuatro péptidos en caja premium PrimeHack: BPC-157 10 mg, TB-500 10 mg, GHK-Cu 50 mg y KPV 10 mg. Orientada a regeneración wellness, recuperación tisular y balance inflamatorio.'},
  ...
  {id:'selank_nasal_10ml', cat:'neuro', tag:'Nasal', nombre:'Selank', presentacion:'Spray nasal · 10 mL', precio:590000, img:'img/selank-nasal-10ml.webp', desc:'Presentación en spray nasal, no invasiva, del péptido neurocognitivo Selank. Orientado a modulación del estrés, equilibrio emocional y claridad mental.'},
  {id:'selank_box', cat:'neuro', tag:'Caja Premium', nombre:'Selank PrimeHack', presentacion:'Caja · 10 mg / vial', precio:400000, img:'img/selank-10mg-primehack.webp', desc:'Péptido neurocognitivo en caja premium PrimeHack. Enfocado en modulación del estrés, equilibrio emocional, claridad mental y soporte funcional del sistema nervioso.'},
  ...
  {id:'semax_box', cat:'neuro', tag:'Caja Premium', nombre:'Semax PrimeHack', presentacion:'Caja · 10 mg / vial', precio:500000, img:'img/semax-10mg-primehack.webp', desc:'Péptido nootrópico en caja premium PrimeHack. Asociado a soporte cognitivo, memoria, enfoque mental, plasticidad neuronal y neuroprotección.'},
  ...
  // ============ KITS DE USO / MATERIAL DE APLICACIÓN ============
  {id:'kit_uso', cat:'kits', tag:'Kit', nombre:'Kit de Uso', presentacion:'5 jeringas de insulina + 1 jeringa 3 ml + 5 paños de alcohol', precio:6500, img:'img/kit-uso-v2.webp', desc:'Kit básico de aplicación: 5 jeringas de insulina, 1 jeringa de 3 ml y 5 paños de alcohol. Elige la presentación de la jeringa de insulina: 0.3 ml (30 ui), 0.5 ml (50 ui) o 1 ml (100 ui) — indícanos la medida al confirmar tu pedido.'},
  {id:'kit_uso_xl', cat:'kits', tag:'Kit XL', nombre:'Kit de Uso XL', presentacion:'10 jeringas de insulina + 2 jeringas 3 ml + 10 paños de alcohol', precio:12500, img:'img/kit-uso-xl-v2.webp', desc:'Kit ampliado de aplicación: 10 jeringas de insulina, 2 jeringas de 3 ml y 10 paños de alcohol. Elige la presentación de la jeringa de insulina: 0.3 ml (30 ui), 0.5 ml (50 ui) o 1 ml (100 ui) — indícanos la medida al confirmar tu pedido.', destacado:true}
];
...
const PRODUCT_DETAIL = {
  ...
  glutation_600mg:{mecanismo:'El glutatión es un tripéptido antioxidante endógeno (ácido glutámico, cisteína y glicina), considerado uno de los principales sistemas de defensa celular frente al estrés oxidativo. Participa en la neutralización de radicales libres, el soporte hepático y la regulación de procesos de desintoxicación celular.',beneficios:['Antioxidante maestro — neutraliza radicales libres','Apoya la función hepática y procesos de desintoxicación celular','Relacionado con la salud celular y el envejecimiento saludable','Presentación de alta pureza (≥99%) en vial de 600 mg'],protocolo:'Se integra en protocolos de soporte antioxidante y longevidad celular bajo criterio profesional. No se publican dosis, frecuencia, vía ni esquemas de uso.',stack:'Sinergia con NAD⁺ y MOTS-C para soporte antioxidante y mitocondrial completo.',nota:'El glutatión es sintetizado naturalmente por el cuerpo, pero sus niveles declinan con la edad y el estrés oxidativo crónico.'},
  ...
  klow_box:{mecanismo:'Klow80 es una formulación de cuatro péptidos de soporte regenerativo — BPC-157, TB-500, GHK-Cu y KPV — enfocada en procesos de reparación tisular, modulación del desgaste físico y recuperación estructural. Su enfoque está relacionado con bienestar articular, soporte de tejidos y balance inflamatorio dentro de protocolos profesionales.',beneficios:['Combina 4 péptidos: BPC-157 10 mg, TB-500 10 mg, GHK-Cu 50 mg y KPV 10 mg','Apoya procesos de recuperación tisular y regeneración funcional','Favorece el equilibrio inflamatorio dentro de protocolos supervisados','Presentación premium PrimeHack en caja'],protocolo:'Soporte wellness y regenerativo bajo criterio profesional. No se detallan dosis, frecuencia, vía ni esquemas de aplicación.',stack:'SS-31, Epithalon, CJC-1295 + Ipamorelin y protocolos de recuperación física.'},
  ...
  selank_nasal_10ml:{mecanismo:'Selank se relaciona con procesos de modulación neuroquímica, respuesta al estrés y equilibrio del sistema nervioso. Esta presentación en spray nasal ofrece una vía de aplicación no invasiva, orientada a apoyar calma mental, estabilidad emocional y claridad cognitiva bajo acompañamiento profesional.',beneficios:['Apoya equilibrio emocional y respuesta adaptativa al estrés','Favorece claridad mental y estabilidad neurocognitiva','Presentación en spray nasal, no invasiva y de fácil manejo','Útil en protocolos de enfoque, calma mental y rendimiento cognitivo'],protocolo:'Presentación en spray nasal de 10 mL. Uso bajo criterio profesional; no se publican dosis, frecuencia ni esquemas de uso.',stack:'Semax, DSIP, Epithalon y protocolos de sueño/estrés.'},
  selank_box:{mecanismo:'Selank se relaciona con procesos de modulación neuroquímica, respuesta al estrés y equilibrio del sistema nervioso. Su enfoque dentro de protocolos neurocognitivos está orientado a apoyar calma mental, estabilidad emocional y claridad cognitiva bajo acompañamiento profesional.',beneficios:['Apoya equilibrio emocional y respuesta adaptativa al estrés','Favorece claridad mental y estabilidad neurocognitiva','Enfocado en bienestar nervioso sin perfil estimulante agresivo','Presentación premium PrimeHack en caja'],protocolo:'Ideal para protocolos de estrés, enfoque, regulación emocional y bienestar neurocognitivo, bajo criterio profesional. No se comunican dosis ni esquemas de uso.',stack:'Semax, DSIP, Epithalon y protocolos de sueño/estrés.'},
  ...
  semax_box:{mecanismo:'Semax se asocia con procesos de señalización neurotrófica, plasticidad sináptica y soporte de funciones cognitivas. Dentro de protocolos profesionales, se presenta como herramienta de apoyo para enfoque, memoria, claridad mental y resiliencia neurológica.',beneficios:['Favorece concentración, memoria y claridad mental','Apoya procesos de plasticidad neuronal y función cognitiva','Enfocado en neuroprotección y rendimiento mental','Presentación premium PrimeHack en caja'],protocolo:'Soporte neurocognitivo dentro de una estrategia profesional. No se publican dosis, vía ni instrucciones de uso.',stack:'Selank, DSIP, SS-31 y protocolos de enfoque mental.'},
  ...
  ipamorelin_5mg_box:{mecanismo:'Ipamorelin se relaciona con la estimulación selectiva de vías asociadas a la liberación pulsátil de GH, apoyando procesos vinculados a recuperación muscular, reparación tisular, composición corporal y homeostasis hormonal. Dentro de protocolos wellness supervisados, se presenta como una herramienta de soporte para recuperación física y crecimiento muscular bajo criterio profesional, evitando promesas de resultados garantizados.',beneficios:['Apoya procesos de recuperación muscular y reparación tisular','Asociado a soporte del eje GH/IGF-1 en protocolos profesionales','Favorece recuperación nocturna y bienestar físico','Útil en estrategias de composición corporal y crecimiento muscular supervisado'],protocolo:'Soporte de recuperación y crecimiento muscular bajo criterio profesional. No se publican dosis, frecuencia, vía, instrucciones de aplicación, reconstitución ni esquemas.',stack:'CJC-1295, SS-31, Epithalon, DSIP y protocolos de recuperación física.'},
  motsc_40mg:{mecanismo:'Péptido de 16 aminoácidos codificado en el ADN mitocondrial (gen 12S rRNA). Bajo estrés metabólico se transloca al núcleo celular y activa AMPK — el sensor maestro del metabolismo — mejorando captación de glucosa y oxidación de grasas en músculo esquelético.',beneficios:['Activa AMPK similar al efecto de la metformina','Mejora la sensibilidad a la insulina en músculo','Aumenta la eficiencia energética mitocondrial','Presentación de alta concentración (40 mg) para protocolos extendidos'],protocolo:'Se integra en protocolos de soporte mitocondrial y metabólico bajo criterio profesional; la presentación de 40 mg está orientada a protocolos extendidos. No se publican dosis ni esquemas de uso.',stack:'Excelente sinergia con NAD⁺ para soporte mitocondrial completo. Complementa GLP-1 agonistas en protocolos metabólicos avanzados.',nota:'MOTS-C fue descubierto en 2015 por el Dr. Pinchas Cohen (USC). Es uno de los pocos péptidos codificados en el ADN mitocondrial — no en el ADN nuclear.'},
  motsc_box:{mecanismo:'Péptido de 16 aminoácidos codificado en el ADN mitocondrial (gen 12S rRNA). Bajo estrés metabólico se transloca al núcleo celular y activa AMPK — el sensor maestro del metabolismo — mejorando captación de glucosa y oxidación de grasas en músculo esquelético.',beneficios:['Activa AMPK similar al efecto de la metformina','Mejora la sensibilidad a la insulina en músculo','Aumenta la eficiencia energética mitocondrial','Presentación premium PrimeHack en caja'],protocolo:'Se integra en protocolos de soporte mitocondrial y metabólico bajo criterio profesional. No se publican dosis ni esquemas de uso.',stack:'Excelente sinergia con NAD⁺ para soporte mitocondrial completo. Complementa GLP-1 agonistas en protocolos metabólicos avanzados.',nota:'MOTS-C fue descubierto en 2015 por el Dr. Pinchas Cohen (USC). Es uno de los pocos péptidos codificados en el ADN mitocondrial — no en el ADN nuclear.'},
  combo_perdida_reparadora:{mecanismo:'Combina un triple agonista incretínico (Retatrutide — vías GLP-1/GIP/glucagón) para señalización metabólica, regulación del apetito y respuesta glucémica, con BPC-157 o TB-500 (a elección), asociados a recuperación, reparación tisular y modulación de la inflamación. Une soporte metabólico y regenerativo en un mismo protocolo.',beneficios:['Apoya control de peso y composición corporal','Favorece recuperación y reparación de tejidos','Combina soporte metabólico y regenerativo en un solo combo','Pensado para protocolos supervisados de pérdida + recuperación'],protocolo:'Se comunica como soporte metabólico y de recuperación bajo criterio profesional. No se publican dosis, frecuencia, vía ni esquemas de uso.',stack:'Retatrutide 10mg PrimeHack + BPC-157 o TB-500 5mg. Complementa con SS-31 y acompañamiento nutricional.'},
  combo_lean_recomp:{mecanismo:'Tesamorelina e Ipamorelina estimulan la producción natural de hormona de crecimiento por vías diferentes: la Tesamorelina como análogo de GHRH que actúa sobre la hipófisis, y la Ipamorelina como secretagogo selectivo de GH. Al combinarse buscan generar una respuesta más completa que la que se conseguiría usando solo uno de los dos compuestos. En palabras sencillas: dos herramientas trabajando juntas para construir un entorno más favorable para perder grasa, conservar músculo y recuperarte mejor.',beneficios:['Reducción progresiva de la grasa abdominal y apariencia más definida','Mayor conservación de masa muscular durante la pérdida de grasa','Mejor recuperación después del entrenamiento','Mejor aprovechamiento del descanso y la regeneración'],protocolo:'Pensado para quienes entrenan y buscan acelerar su recomposición corporal, para quienes han avanzado pero la grasa abdominal sigue difícil de movilizar, y para quienes quieren definición sin sacrificar el músculo construido. Uso bajo criterio profesional; no se publican dosis, frecuencia ni esquemas.',stack:'Tesamorelina 10 mg + Ipamorelina 5 mg. Se complementa con acompañamiento nutricional y de entrenamiento.',nota:'No se trata simplemente de bajar kilos: se trata de mejorar la forma en que se ve y se siente tu cuerpo.'},
  combo_shape_glow:{mecanismo:'Retatrutide se encarga del componente metabólico: ayuda a controlar el apetito y crea un entorno favorable para reducir peso. GHK-Cu complementa el proceso desde el componente regenerativo, apoyando mecanismos relacionados con el colágeno, la reparación y la remodelación del tejido. En palabras sencillas: Retatrutide transforma tu composición corporal; GHK-Cu acompaña la transformación de tu piel.',beneficios:['Favorece una pérdida de peso progresiva','Mejora el control del apetito y la adherencia al proceso','Acompaña los cambios físicos durante la reducción de peso','Apoya la producción de colágeno y la renovación del tejido','Cuida la apariencia y firmeza de la piel durante la transformación'],protocolo:'Pensado para personas que buscan bajar de peso pero también quieren cuidar cómo se ve su cuerpo durante el proceso, sobre todo cuando anticipan una reducción considerable o les preocupa perder firmeza en la piel. Uso bajo criterio profesional; no se publican dosis, frecuencia ni esquemas.',stack:'Retatrutide 10 mg + GHK-Cu 50 mg. Se complementa con acompañamiento nutricional e hidratación adecuada.',nota:'Cuando el cuerpo cambia, la transformación no se refleja solamente en la balanza.'},
  kit_uso:{mecanismo:'Kit de material para la aplicación e higiene de tu protocolo. Incluye jeringas de insulina para dosis pequeñas y precisas, una jeringa de 3 ml para reconstitución y manejo del vial, y paños de alcohol para la asepsia de la zona y del tapón antes de cada uso.',beneficios:['5 jeringas de insulina de un solo uso','1 jeringa de 3 ml para reconstitución','5 paños de alcohol para asepsia','Presentación de la jeringa de insulina a elección'],protocolo:'Elige la presentación de la jeringa de insulina: 0.3 ml (30 ui), 0.5 ml (50 ui) o 1 ml (100 ui), e indícanos la medida al confirmar tu pedido por WhatsApp. Material estéril de un solo uso: no reutilizar y desechar de forma segura tras cada aplicación.',stack:'Complementa con Agua Bacteriostática para la reconstitución de tus péptidos.'},
  kit_uso_xl:{mecanismo:'Versión ampliada del kit de material para la aplicación e higiene de tu protocolo. Incluye jeringas de insulina para dosis pequeñas y precisas, jeringas de 3 ml para reconstitución y manejo del vial, y paños de alcohol para la asepsia de la zona y del tapón antes de cada uso. Ideal para protocolos extendidos o de mayor frecuencia.',beneficios:['10 jeringas de insulina de un solo uso','2 jeringas de 3 ml para reconstitución','10 paños de alcohol para asepsia','Presentación de la jeringa de insulina a elección'],protocolo:'Elige la presentación de la jeringa de insulina: 0.3 ml (30 ui), 0.5 ml (50 ui) o 1 ml (100 ui), e indícanos la medida al confirmar tu pedido por WhatsApp. Material estéril de un solo uso: no reutilizar y desechar de forma segura tras cada aplicación.',stack:'Complementa con Agua Bacteriostática para la reconstitución de tus péptidos.'}
};
...
const CAT_META = {
  ...
  kits: {
    label:'Kits de uso',
    sub:'Jeringas de insulina, jeringas 3 ml y paños de alcohol',
    icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="m18 2 4 4"/><path d="m17 7 3-3"/><path d="M19 9 8.7 19.3c-1 1-2.5 1-3.4 0l-.6-.6c-1-1-1-2.5 0-3.4L15 5"/><path d="m9 11 4 4"/><path d="m5 19-3 3"/><path d="m14 4 6 6"/></svg>'
  }
};
...
function openCart(){ $('#cartDrawer').classList.add('open'); $('#overlay').classList.add('show'); $('#cartDrawer').setAttribute('aria-hidden','false'); document.body.style.overflow='hidden'; document.documentElement.style.overflow='hidden'; }
function closeCart(){ $('#cartDrawer').classList.remove('open'); $('#overlay').classList.remove('show'); $('#cartDrawer').setAttribute('aria-hidden','true'); document.body.style.overflow=''; document.documentElement.style.overflow=''; }

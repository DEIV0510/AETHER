...
const PRODUCTS = [
  ...
  {id:'tirzepatide_20mg', cat:'metabolico', tag:'GLP', nombre:'Tirzepatide', presentacion:'20 mg / vial', precio:900000, img:'img/tirzepatide-20mg.webp', desc:'Agonista dual GLP-1/GIP en presentación de mayor concentración. Control del apetito, regulación de glucosa y pérdida de grasa corporal.'},
  ...
  {id:'epithalon_50mg', cat:'longevidad', tag:'Longevidad', nombre:'Epithalon', presentacion:'50 mg / vial', precio:750000, img:'img/epithalon-50mg.webp', desc:'Péptido enfocado en longevidad celular, descanso profundo y soporte de regulación circadiana.'},
  {id:'dsip_10mg', cat:'longevidad', tag:'Descanso', nombre:'DSIP', presentacion:'10 mg / vial', precio:320000, img:'img/dsip-10mg.webp', desc:'Péptido enfocado en descanso, sueño profundo y recuperación del sistema nervioso.'},
  {id:'ss31_10mg', cat:'longevidad', tag:'Mitocondrial', nombre:'SS-31', presentacion:'10 mg / vial', precio:250000, img:'img/ss31-10mg.webp', desc:'Péptido mitocondrial enfocado en energía celular, recuperación y soporte frente al estrés oxidativo.'},
...
const PRODUCT_DETAIL = {
  ...
  tirzepatide_20mg:{mecanismo:'Agonista dual GLP-1/GIP en presentación de alta concentración. Actúa en los mismos receptores con mayor flexibilidad de dosificación, ofreciendo control prolongado del apetito y la glucemia.',beneficios:['Presentación óptima para protocolos avanzados','Menor número de reconstituciones para uso extendido','Mismo perfil de seguridad que presentaciones menores','Ideal para usuarios con experiencia previa en GLP-1'],protocolo:'Administración subcutánea semanal con escalamiento gradual. La presentación 20 mg permite mayor flexibilidad de fraccionamiento. Ciclos de 12–24 semanas.',stack:'Compatible con AOD-9604 para lipólisis adicional. Puede complementarse con MOTS-C o 5-Amino-1MQ para optimización metabólica.',nota:'La presentación de mayor concentración permite gestionar ciclos completos con un solo vial, optimizando la logística de protocolos extendidos.'},
  ...
  epithalon_50mg:{mecanismo:'Relacionado con procesos de regulación celular, ritmo biológico y soporte de reparación nocturna.',beneficios:['Apoya protocolos de envejecimiento saludable','Favorece descanso, reparación nocturna y balance biológico','Asociado a investigación sobre telómeros y telomerasa','Ideal como soporte en protocolos de longevidad y recuperación'],protocolo:'Orientado a bienestar celular, sueño y recuperación. Siempre bajo evaluación y seguimiento profesional; no se publican esquemas de uso en material público.',stack:'Combina bien con DSIP, SS-31, Selank y protocolos de recuperación integral.'},
  dsip_10mg:{mecanismo:'Relacionado con la modulación del descanso, la recuperación nocturna y la regulación del sistema nervioso.',beneficios:['Soporte para la calidad del sueño','Favorece la recuperación nocturna','Enfocado en descanso profundo y equilibrio nervioso','Útil en protocolos donde el sueño es prioridad'],protocolo:'Enfocado en descanso y recuperación, siempre bajo criterio profesional. No se publican dosis ni esquemas de uso.',stack:'Combina bien con Epithalon, Selank, Semax y protocolos de control de estrés.'},
  ss31_10mg:{mecanismo:'Actúa como soporte mitocondrial, ayudando a proteger la función celular frente al estrés oxidativo.',beneficios:['Apoya la función mitocondrial','Enfocado en energía celular y vitalidad','Favorece la recuperación en protocolos de alto desgaste','Soporte para la salud celular y el rendimiento metabólico'],protocolo:'Se integra en protocolos de soporte mitocondrial, fatiga y recuperación, siempre con criterio profesional. No se publican esquemas de uso.',stack:'Combina bien con Epithalon, Tirzepatide, CJC-1295 + Ipamorelin y protocolos metabólicos.'},
  klow_80mg:{mecanismo:'Diseñado como soporte integral para procesos de regeneración, reparación tisular y bienestar físico.',beneficios:['Apoya protocolos de reparación y recuperación','Enfocado en tejidos, piel, articulaciones y balance inflamatorio','Soporte integral para el desgaste físico','Útil en protocolos de recuperación avanzada'],protocolo:'Blend de soporte wellness orientado a la recuperación física, siempre bajo evaluación profesional. No se publican esquemas de uso.',stack:'Combina bien con SS-31, Epithalon, CJC-1295 + Ipamorelin y protocolos de recuperación física.'},
  selank_10mg:{mecanismo:'Relacionado con la regulación de neurotransmisores, la respuesta al estrés y el equilibrio del sistema nervioso.',beneficios:['Apoya el equilibrio emocional','Enfocado en estrés, calma mental y claridad','Favorece la concentración sin un enfoque estimulante agresivo','Útil en protocolos de rendimiento mental y bienestar nervioso'],protocolo:'Ideal para protocolos de estrés, enfoque y regulación emocional, siempre bajo criterio profesional. No se comunican esquemas de uso.',stack:'Combina bien con Semax, DSIP, Epithalon y protocolos de sueño/estrés.'},
  semax_10mg:{mecanismo:'Relacionado con procesos de plasticidad neuronal, enfoque mental y soporte de funciones cognitivas.',beneficios:['Favorece la concentración y el rendimiento cognitivo','Apoya memoria, enfoque y claridad mental','Enfocado en neuroprotección y plasticidad cerebral','Útil en protocolos de productividad y desempeño mental'],protocolo:'Soporte cognitivo dentro de una estrategia profesional. No se publican dosis ni instrucciones de uso.',stack:'Combina bien con Selank, DSIP, SS-31 y protocolos de enfoque mental.'},
  cjc_ipamorelin:{mecanismo:'Combinación de secretagogos asociados a la estimulación pulsátil de GH dentro de protocolos supervisados.',beneficios:['Apoya la recuperación muscular y articular','Enfocado en descanso profundo y reparación nocturna','Favorece protocolos de composición corporal','Secretagogos de GH con enfoque de recuperación integral'],protocolo:'Protocolo de recuperación y soporte hormonal bajo evaluación profesional. No se publican dosis ni esquemas de uso.',stack:'Combina bien con SS-31, Epithalon, DSIP y protocolos de sueño/recuperación.'},
  epithalon_box:{mecanismo:'Relacionado con procesos de regulación celular, soporte de telómeros y equilibrio biológico.',beneficios:['Enfocado en longevidad celular','Apoya descanso profundo y reparación nocturna','Ideal para protocolos premium de bienestar y envejecimiento saludable','Soporte avanzado para la regulación circadiana'],protocolo:'Orientado a protocolos de longevidad bajo criterio profesional. No se detallan dosis ni instrucciones de uso en material público.',stack:'Combina bien con DSIP, SS-31, Selank y estrategias de bienestar integral.'}
};

...
const PRODUCTS = [
  ...
  {id:'combo_perdida_reparadora', cat:'metabolico', tag:'Combo', nombre:'Combo Pérdida Reparadora', presentacion:'Retatrutide 10mg PrimeHack + BPC/TB-500 5mg', precio:785000, img:'img/combo-perdida-reparadora.webp', desc:'Por la compra de un Retatrutide 10mg PrimeHack llevas una unidad de BPC-157 + TB-500 5mg (FastMuscle). Une pérdida de peso metabólica con recuperación y reparación tisular en un solo protocolo.', destacado:true},
...
const PRODUCT_DETAIL = {
  ...
  combo_perdida_reparadora:{mecanismo:'Combina un triple agonista incretínico (Retatrutide — vías GLP-1/GIP/glucagón) para señalización metabólica, regulación del apetito y respuesta glucémica, con BPC-157 + TB-500, asociados a recuperación, reparación tisular y modulación de la inflamación. Une soporte metabólico y regenerativo en un mismo protocolo.',beneficios:['Apoya control de peso y composición corporal','Favorece recuperación y reparación de tejidos','Combina soporte metabólico y regenerativo en un solo combo','Pensado para protocolos supervisados de pérdida + recuperación'],protocolo:'Se comunica como soporte metabólico y de recuperación bajo criterio profesional. No se publican dosis, frecuencia, vía ni esquemas de uso.',stack:'Retatrutide 10mg PrimeHack + BPC-157/TB-500 5mg. Complementa con SS-31 y acompañamiento nutricional.'}
};
